        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m.ppRigidbodiesAllowed)
            {
                ...
                if (!m.ppAdjustTrackSizeToInputSize)
                    ppDrawProperty("ppRadius", "Interactive Radius", "Radius of vertices to be interacted. Please keep in mind that if the input for mesh modify is RayEvent with Spherical Raycast, this field is no more required");
                pve();
            }
